...
$faiz = new Mahasiswa('02013', 'muhammad mikael');
$alissa = new Mahasiswa('02014', 'ratu widyaningrat');
$rosalie = new Mahasiswa('02011', 'muhammad ghino');
$defghi = new Mahasiswa('04013', 'dwi putri raihan');
